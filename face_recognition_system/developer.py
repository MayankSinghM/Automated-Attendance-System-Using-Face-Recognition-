...
class Developer:
    def __init__(self,root):
        ...
        img_top = Image.open(r"college_images\dv.jpg")
        ...
        img_top1= Image.open(r"college_images\m.jpg")
        ...
        dev_label=Label(main_frame,text="Hello my name is Mayank",font=("times new roman",20,"bold"),bg="white",fg="blue")
        dev_label.place(x=0,y=5)

        dev_label=Label(main_frame,text="Machine Learning developer",font=("times new roman",20,"bold"),bg="white",fg="blue")
        dev_label.place(x=0,y=40)


        img2=Image.open(r"college_images\dv3.webp")
