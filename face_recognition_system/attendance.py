...
class Attendance:
    def __init__(self,root):
        ...
        self.var_atten_attendance=StringVar()
         ...
         #first image
        img = Image.open(r"college_images\Untitled.jpg")
        ...
        #second image
        img1 = Image.open(r"college_images\images3.jpg")
        ...
        #bg image
        img3 = Image.open(r"college_images\bgimage4.jpg")
        ...
        #sturdent name
        nameLabel=Label(left_inside_frame,text="StudentName:",font=("times new roman",12,"bold"),bg="white")
        ...
        atten_dep=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_time,font=("times new roman",12,"bold"))
        ...
        delete_btn = Button(btn_frame,text="Update",command=self.get_cursor,width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
