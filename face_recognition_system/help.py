...
class Help:
    def __init__(self,root):
        ...
        img_top = Image.open(r"college_images\help1.jpg")
        ...
        dev_label=Label(first_label,text="Email:mayankmanral35@gamil.com",font=("times new roman",20,"bold"),bg="white",fg="blue")
