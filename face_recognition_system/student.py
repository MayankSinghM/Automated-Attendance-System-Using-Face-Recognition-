...
class Student:
    def __init__(self,root):
        ...
        img_left = Image.open(r"C:\Users\mayan\OneDrive\Desktop\FaceRecognitionSystem\college_images\student management.jpg")
        ...
        course_combo["values"]=("Select Course","1st","2nd","3rd","4th")
        ...
        img_right = Image.open(r"C:\Users\mayan\OneDrive\Desktop\FaceRecognitionSystem\college_images\student.jpg")
       ...
       # Packing the scrollbars
        scroll_x.pack(side=BOTTOM, fill=X)  # Horizontal scrollbar at the bottom
        scroll_y.pack(side=RIGHT, fill=Y)   # Vertical scrollbar on the right

        # Configuring the scrollbars to work with the table
        scroll_x.config(command=self.student_table.xview)  # Horizontal scrolling
        scroll_y.config(command=self.student_table.yview)  # Vertical scrolling
        ...
        # Example of adjusting specific column widths
        ...
        # Packing the table to fill the space and allow it to expand
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()== "":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Example@2022#",database="face_recognizer")
